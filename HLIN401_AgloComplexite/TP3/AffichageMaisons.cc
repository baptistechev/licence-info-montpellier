...
void AffichageMaisons(int n, const int coordMaison[][2], string nom)
...
void AffichageMaisonsEmetteurs(int n, const int coordMaison[][2], const bool emetteur[], string nom)
